...
import { signUp, techExpertRegister } from '../../utils/api';

const TechExpertRegistration = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const response = await techExpertRegister(signupData);
            if (response.ok) {
    ...
    return (
        <Container className="container-2">
            <div className="form form-2">
                <h2 className="text-center mb-4">Tech Expert Sign Up</h2>
                {showSuccessAlert && (
                ...
                <Form onSubmit={handleSubmit}>
                    ...
                    <Row>
                        <Col xs={12} sm={6}>
                            <Form.Group controlId="qualification" className="pb-4">
                                <Form.Control
                                    className="large-input"
                                    type="text"
                                    name="qualification"
                                    ...
                                    onChange={handleChange}
                                    minLength="3"
                                    isInvalid={!!signupErrors.qualification}
                                    placeholder="Qualification"
                                />
                                <Form.Control.Feedback type="invalid">
                                    {signupErrors.qualification}
                                </Form.Control.Feedback>
                            </Form.Group>
                        </Col>
                        <Col xs={12} sm={6}>
                            <Form.Group controlId="experiance" className='pb-4'>
                                <Form.Control
                                    className="large-input"
                                    type="text"
                                    name="experiance"
                                    value={signupData.experiance}
                                    onChange={handleChange}
                                    isInvalid={!!signupErrors.experiance}
                                    placeholder="Experiance"
                                />
                                <Form.Control.Feedback type="invalid">
                                    {signupErrors.experiance}
                                </Form.Control.Feedback>
                            </Form.Group>
                        </Col>
                    </Row>
...
export default TechExpertRegistration
