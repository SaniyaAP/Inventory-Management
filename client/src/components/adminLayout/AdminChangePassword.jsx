...
import { adminChangePassword, changeUserPassword } from '../../utils/api';

const AdminChangePassword = () => {
    const { admin, updateUserData } = useAdminData();
    ...
    const handleChangePasswordSubmit = async (e) => {
        ...
        try {
            const response = await adminChangePassword(admin._id, changePasswordData);
            if (response.ok) {
